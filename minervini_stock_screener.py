...
ttl  = "Open the Stocks sheet"
dir1 = '/home/rishabhgarg/Downloads/'
# filePath = askopenfilename(filetypes = ftypes, initialdir = dir1, title = ttl)
# filePath = easygui.fileopenbox(msg="Please open the required file",
# title=ttl,default=dir1, filetypes=ftypes,multiple=True)
filePath=r"/home/rishabhgarg/Downloads/Sample_stocks.ods"
...
newFile = os.path.dirname(filePath)+"/ScreenOutput.ods"
